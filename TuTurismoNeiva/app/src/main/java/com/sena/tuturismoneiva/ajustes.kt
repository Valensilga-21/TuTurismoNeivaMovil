    ...
    class ajustes : Fragment() {
        ...
        override fun onCreateView(
            ...
            val btnAyuda = view.findViewById<Button>(R.id.btnAyuda)
            btnAyuda.setOnClickListener {
                val pdfUrl = "https://drive.google.com/file/d/1CdjVFwV44JcKzvTFqoKqRxB6fXytIE3U/view?usp=drive_link"
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(pdfUrl))
                startActivity(intent)
            }

            val btnAyuda2 = view.findViewById<Button>(R.id.btnAyuda2)
            btnAyuda2.setOnClickListener {
                val pdfUrl = "https://drive.google.com/file/d/1CdjVFwV44JcKzvTFqoKqRxB6fXytIE3U/view?usp=drive_link"
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(pdfUrl))
                startActivity(intent)
            }
